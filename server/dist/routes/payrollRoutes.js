...
router.get('/batches', authorize('hr_admin', 'finance_admin', 'finance_sub_admin', 'superadmin'), getPayrollBatches);
router.get('/batches/:id', authorize('hr_admin', 'finance_admin', 'finance_sub_admin', 'superadmin'), getPayrollBatch);
...
router.post('/generate', authorize('hr_admin', 'finance_admin', 'finance_sub_admin'), generateMonthlyPayroll);
router.post('/transfer-to-finance', authorize('hr_admin', 'superadmin'), transferToFinance);
// Payroll CRUD
router.route('/').get(getPayrolls).post(authorize('hr_admin', 'finance_admin', 'finance_sub_admin'), createPayroll);
router.route('/:id').get(getPayroll).put(authorize('hr_admin', 'finance_admin', 'finance_sub_admin'), updatePayroll).delete(authorize('hr_admin', 'finance_admin', 'finance_sub_admin'), deletePayroll);
// Payroll instance actions
router.put('/:id/process', authorize('hr_admin', 'finance_admin', 'finance_sub_admin'), processPayroll);
