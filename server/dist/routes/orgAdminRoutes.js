...
import { createCeoPanel, getCeoPanels, getCeoPanel, updateCeoPanel, deleteCeoPanel, createCustomDepartment, getCustomDepartments, getOrgHierarchy, assignHierarchy, getDesignations, createDesignation, updateDesignation, deleteDesignation, assignUserToDesignation, unassignUserFromDesignation, } from '../controllers/orgAdminController.js';
import { getBranches, getBranch, createBranch, updateBranch, deleteBranch, assignBranchManager, updateBranchDepartments, getMyBranch, } from '../controllers/branchController.js';
...
router.get('/branches', authorize('org_admin', 'superadmin', 'hr_admin', 'hr_sub_admin', 'ceo', 'general_manager', 'ops_admin', 'sales_admin', 'sales_sub_admin', 'finance_admin', 'finance_sub_admin', 'ops_sub_admin'), getBranches);
router.use(authorize('org_admin', 'superadmin', 'hr_admin', 'hr_sub_admin', 'ceo', 'general_manager'));
// CEO Panel routes
...
//# sourceMappingURL=orgAdminRoutes.js.map