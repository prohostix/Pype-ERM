...
router.route('/:id')
    .get(getEscalation)
    .put(authorize('ceo', 'general_manager', 'ops_admin', 'finance_admin', 'finance_sub_admin', 'hr_admin', 'sales_admin', 'sales_sub_admin'), updateEscalation)
    .delete(authorize('ceo', 'general_manager', 'superadmin'), deleteEscalation);
router.put('/:id/resolve', authorize('ceo', 'general_manager', 'ops_admin', 'finance_admin', 'finance_sub_admin', 'hr_admin', 'sales_admin', 'sales_sub_admin'), resolveEscalation);
