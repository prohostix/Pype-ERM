...
import { getOrganizations, getOrganization, createOrganization, updateOrganization, deleteOrganization, assignLicense, getOrgInquiries, updateOrgInquiryStatus, } from '../controllers/organizationController.js';
...
router
    .route('/')
    .get(authorize('superadmin', 'org_admin', 'ceo', 'general_manager', 'hr_admin', 'finance_admin', 'finance_sub_admin', 'ops_admin', 'ops_sub_admin', 'sales_admin', 'sales_sub_admin', 'employee'), getOrganizations)
