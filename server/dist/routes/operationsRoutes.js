...
import { getUniversities, getUniversity, createUniversity, updateUniversity, deleteUniversity, activateUniversity, getPrograms, getProgram, createProgram, updateProgram, deleteProgram, activateProgram, getStudyCenters, getStudyCenter, createStudyCenter, updateStudyCenter, deleteStudyCenter, approveStudyCenter, suspendStudyCenter, getAdmissionSessions, getAdmissionSession, createAdmissionSession, updateAdmissionSession, deleteAdmissionSession, approveAdmissionSession, getInternalMarks, createInternalMark, updateInternalMark, deleteInternalMark, getAnnouncements, getAnnouncement, createAnnouncement, updateAnnouncement, deleteAnnouncement, getPendingVerificationCenters, verifyCenter, getProgramAllocations, allocateProgram, removeAllocation, } from '../controllers/operationsController.js';
import { getProgramDetail, getProgramMaterials, uploadProgramMaterial, updateProgramMaterial, deleteProgramMaterial, } from '../controllers/programMaterialController.js';
...
// Admission Sessions
router.route('/sessions').get(getAdmissionSessions).post(authorize('org_admin', 'superadmin', 'ops_admin', 'ceo'), createAdmissionSession);
router.route('/sessions/:id')
    .get(getAdmissionSession)
    .put(authorize('org_admin', 'superadmin', 'ops_admin', 'ceo'), updateAdmissionSession)
    .delete(authorize('org_admin', 'superadmin', 'ops_admin', 'ceo'), deleteAdmissionSession);
