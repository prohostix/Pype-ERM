...
import { createSubDepartment, getSubDepartments, getSubDepartment, updateSubDepartment, deleteSubDepartment, getMySubDepartment, } from '../controllers/subDepartmentController.js';
...
router.patch('/:id', authorize('ops_admin', 'sales_admin', 'sales_sub_admin', 'org_admin', 'superadmin', 'hr_admin', 'hr_sub_admin'), updateSubDepartment);
