...
export const getDepartments = asyncHandler(async (req, res) => {
    ...
    if (req.query.parentDepartmentId) {
        where.parentDepartmentId = req.query.parentDepartmentId;
    }
...
// @access  Private (OrgAdmin, Superadmin)
export const addAssistantManager = asyncHandler(async (req, res) => {
...
// @access  Private (OrgAdmin, Superadmin)
export const removeAssistantManager = asyncHandler(async (req, res) => {
