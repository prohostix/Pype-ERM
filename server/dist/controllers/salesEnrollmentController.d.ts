...
export declare const validateStudentInviteToken: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const submitStudentApplication: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getSalesEnrollmentPipeline: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const approveSalesEnrollmentOps: (req: Request, res: Response, next: import("express").NextFunction) => void;
