...
export const getSessionRequest = asyncHandler(async (req, res) => {
    const request = await prisma.sessionRequest.findUnique({ where: { id: req.params.id }, include: { center: true } });
    res.json({ success: true, data: request });
});
export const createSessionRequest = asyncHandler(async (req, res) => {
...
export const approveSessionRequest = asyncHandler(async (req, res) => {
...
export const rejectSessionRequest = asyncHandler(async (req, res) => {
    const request = await prisma.sessionRequest.update({ where: { id: req.params.id }, data: { status: 'rejected' } });
    res.json({ success: true, data: request });
});
export const getSessionRequestStats = asyncHandler(async (req, res) => {
    res.json({ success: true, data: {} });
});
//# sourceMappingURL=sessionRequestController.js.map