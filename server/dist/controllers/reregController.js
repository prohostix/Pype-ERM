...
export const createOrUpdateReregRules = asyncHandler(async (req, res) => {
...
export const getPendingReregs = asyncHandler(async (req, res) => {
    res.json({ success: true, count: 0, data: [] });
});
export const getCompletedReregs = asyncHandler(async (req, res) => {
    res.json({ success: true, count: 0, data: [] });
});
export const processRereg = asyncHandler(async (req, res) => {
    res.json({ success: true, data: { id: req.params.id, status: 'completed' } });
});
export const carryForwardMissedReregs = asyncHandler(async (req, res) => {
    res.json({ success: true, message: 'Missed reregs carried forward' });
});
export const getReregStats = asyncHandler(async (req, res) => {
    res.json({ success: true, data: {} });
});
//# sourceMappingURL=reregController.js.map