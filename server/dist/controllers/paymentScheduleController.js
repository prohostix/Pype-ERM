...
export const getPaymentSchedules = asyncHandler(async (req, res) => {
...
export const updatePaymentSchedule = asyncHandler(async (req, res) => {
    const { id } = req.params;
...
export const deletePaymentSchedule = asyncHandler(async (req, res) => {
    const { id } = req.params;
    const exists = await prisma.paymentSchedule.findFirst({
        where: { id, organizationId: req.user.organizationId }
    });
...
//# sourceMappingURL=paymentScheduleController.js.map