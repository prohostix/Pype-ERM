...
export const getCredentialRequest = asyncHandler(async (req, res) => {
    const request = await prisma.credentialRequest.findUnique({ where: { id: req.params.id } });
    res.json({ success: true, data: request });
});
export const submitCredentialRequest = asyncHandler(async (req, res) => {
...
export const respondToCredentialRequest = asyncHandler(async (req, res) => {
