...
export const getMyLeaveBalance = asyncHandler(async (req, res) => {
    ...
    const usedSickThisMonth = usedSickThisMonthRaw.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
    ...
    const usedCasualRecent = usedCasualRecentRaw.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
    ...
    const usedEarned = usedEarnedRaw.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
    // 4. Unpaid Leave
    ...
    const unpaidTaken = unpaidRaw.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
    const balance = {
        sick: {
    ...
    if (type === 'sick' || type === 'casual') {
        ...
        if (!allocation) {
            ...
            if (type === 'sick') {
                ...
                const usedDays = usedSickThisMonth.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
                ...
                const usedDays = usedCasualRecent.reduce((acc, l) => acc + (l.isHalfDay ? 0.5 : (l.endDate.getTime() - l.startDate.getTime()) / 86400000 + 1), 0);
