    ...
    <Card className="border-none shadow-none">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Comprehensive report of student demographics and statuses</CardDescription>
          </div>
      ...
      <CardContent>
        <div className="flex flex-col items-center justify-center p-8 text-center border rounded-lg border-dashed">
          ...
          <p className="text-muted-foreground">Select filters to generate report</p>
        </div>
      </CardContent>
    </Card>
  );
